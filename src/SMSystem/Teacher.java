...
public class Teacher extends Employee implements Teachable {
	...
	public Teacher(Name name, Gender gender, CivilStatus marriageStatus, LocalDate birthDate, LocalDate startDate,
			double startSalary) {
	...
	public String toString() {
		...
		return "Öğretmen. [" + this.getRegistrationNumber() + " " + this.getName() + " " + this.getBirthDate() + " "
				+ this.getStartDate() + " " + startSal + " " + curSal + "]";
	}
