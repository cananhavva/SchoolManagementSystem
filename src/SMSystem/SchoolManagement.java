...
public class SchoolManagement implements Serializable {
	...
	private void giftRecipients() {
		...
		for (Employee employee : employees) {
			if (!employee.isOldEmployee()) {
				if (employee.getBirthDate().getMonth().getValue() == currDate.getMonth().getValue()
						&& employee.getGender() == Gender.WOMAN)
	...
	private void assignStudent() {
		...
		Student s1 = new Student(new Name("Student", "1"), Gender.MAN, LocalDate.parse("2006-11-10"),
				LocalDate.parse("2020-09-01"));
		this.students.put("2020-0001", s1);
		Student s2 = new Student(new Name("Student", "2"), Gender.WOMAN, LocalDate.parse("2005-12-11"),
				LocalDate.parse("2019-09-01"));
		this.students.put("2019-0002", s2);
		Student s3 = new Student(new Name("Student", "3"), Gender.WOMAN, LocalDate.parse("2008-01-12"),
				LocalDate.parse("2021-09-01"));
		this.students.put("2021-0003", s3);
		Student s4 = new Student(new Name("Student", "4"), Gender.WOMAN, LocalDate.parse("2006-07-13"),
				LocalDate.parse("2019-09-01"));
		this.students.put("2019-0004", s4);
		Student s5 = new Student(new Name("Student", "5"), Gender.MAN, LocalDate.parse("2006-11-14"),
				LocalDate.parse("2019-09-01"));
		this.students.put("2019-0005", s5);
		Student s6 = new Student(new Name("Student", "6"), Gender.MAN, LocalDate.parse("2005-06-15"),
				LocalDate.parse("2018-09-01"));
		this.students.put("2018-0006", s6);
		Student s7 = new Student(new Name("Student", "7"), Gender.WOMAN, LocalDate.parse("2006-02-16"),
				LocalDate.parse("2020-09-01"));
		this.students.put("2020-0007", s7);
		Student s8 = new Student(new Name("Student", "8"), Gender.WOMAN, LocalDate.parse("2007-12-17"),
				LocalDate.parse("2020-09-01"));
		this.students.put("2020-0008", s8);
		Student s9 = new Student(new Name("Student", "9"), Gender.MAN, LocalDate.parse("2006-11-18"),
				LocalDate.parse("2020-09-01"));
	...
	private void newClass() {
		...
		LecturingClass l1 = new LecturingClass("Ders 1", m1, a1, LocalDate.now().getYear(), 2, DayOfWeek.MONDAY,
				LocalTime.of(13, 30));
		LecturingClass l2 = new LecturingClass("Ders 2", m1, a1, LocalDate.now().getYear(), 4, DayOfWeek.THURSDAY,
				LocalTime.of(9, 0));
		LecturingClass l3 = new LecturingClass("Ders 3", m2, a1, LocalDate.now().getYear(), 3, DayOfWeek.WEDNESDAY,
				LocalTime.of(10, 0));
