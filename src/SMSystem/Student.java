...
public class Student extends Person {
	...
	public String toString() {
		return "Öğrenci [Number=" + this.registrationNumber + ", Name=" + this.getName() + ", startDate="
				+ this.startDate + ", takenClasses=" + this.takenClasses + ", currentYear=" + this.getCurrentClass()
				+ ", telephonNumbers=" + Arrays.toString(this.telephonNumbers) + "]";
	}
