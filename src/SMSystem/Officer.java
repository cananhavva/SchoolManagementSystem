...
public class Officer extends Employee implements Accountable {
	...
	public Officer(Name name, Gender gender, CivilStatus marriageStatus, LocalDate birthDate, LocalDate startDate,
			double startSalary) {
	...
	public String toString() {
		...
		return "Memur.    [" + this.getRegistrationNumber() + " " + this.getName() + " " + this.getBirthDate() + " "
